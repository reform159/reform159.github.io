...
<body>
    ...
    <div class="page pageContacts container">
    <h1>Контакты</h1>
    <div class="row justify-content-center">
        <div class="col-12 col-lg-3"></div>
        <div class="col-12 col-lg-4">
            <div class="contact">
                <div class="rhomb"><img src="assets/img/vk.svg"></div>
                <div>
                    <div>Мы ВКонтакте:</div>
                    <a href="https://vk.com/alarmpay" target="_blank">vk.com/alarmpay</a>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-5">
            <div class="contact">
                <div class="rhomb"><img src="assets/img/email.svg"></div>
                <div>
                    <div>Электронная почта:</div>
                    <a href="mailto:manage@iUrMine.ru">manage@iUrMine.ru</a>
                </div>
            </div>
        </div>
    </div>
