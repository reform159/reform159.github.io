...
!function (t, e) {
  ...
  var be = "tooltip",
    ...
    return t.enable = function () {
      ...
      "object" != _typeof(e) || !e.nodeType && !e.jquery ? this.config.php ? (this.config.sanitize && (e = Se(e, this.config.whiteList, this.config.sanitizeFn)), t.php(e)) : t.text(e) : this.config.php ? g(e).parent().is(t) || t.empty().append(e) : t.text(g(e).text());
    }, t.getTitle = function () {
